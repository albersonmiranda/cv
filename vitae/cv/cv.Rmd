...
tribble(
  ...
  "Advisor (Rural Credit Office)", "Bank of the State of Espírito Santo", "Vitória, Brazil", "Sep. 2025 - Present",
  c(
    "Develop and maintain data products to support rural credit operations.",
    "Stack: Typescript, Google Appscripts, Python, R, DuckDB."
  ),
  "Advisor (Credit Risk Modeling Office)", "Bank of the State of Espírito Santo", "Vitória, Brazil", "Jul. 2024 - Aug. 2025",
  c(
