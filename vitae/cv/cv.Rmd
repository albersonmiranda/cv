...
tribble(
  ...
  "Advisor", "Banestes SA", "Vitória, Brazil", "Apr. 2022 - Present",
    list("Analytics in Credit Innovation Office.",
  ...
  "Squads Coordinator", "Banestes SA", "Vitória, Brazil", "Jan. 2020 - Sep. 2021",
    list("Develop models, tests and statistical experiments to assist in the decision making and data-related products."
    ),
  "Head of Collection", "Banestes SA", "Vitória, Brazil", "Apr. 2014 - Dec. 2019",
    list("Developed strategies and managed contracts.",
         "Applied of econometric techniques for collection and budget planning."
    ),
...
tribble(
  ...
  "M.Sc in Economics", "Universidade Federal do Espírito Santo", "Vitória, Brazil", "Jan. 2022 - Dec. 2023",
    list("Thesis: Optimal Probabilistic Forecast Conciliation for Hierarquical Time Series",
